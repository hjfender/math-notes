...
\begin{theorem}[Induction on $\omega$]
...
\begin{theorem}[Trichotomy Law for $\omega$]\label{trichotomy}
...
\begin{theorem}[Well Ordering of $\omega$]\label{wellorderingofnaturalnumbers}
...
\begin{theorem}[Strong Induction Principle for $\omega$]
